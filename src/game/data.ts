...
export const npcs: Npc[] = [
  ...
  { id: 'mina', name: '弥奈', role: '风信使', locationId: 'mayor-home', description: '村长家的女儿，总是第一个听到远方的新鲜事。', availableActions: ['chat','gift','quest','profile'], preferredGifts: ['silver-carp','berry-tart'], birthday: { month: 5, day: 17 } },
  ...
  { id: 'taomi', name: '桃弥', role: '账房', locationId: 'general-store', description: '算盘快得像雨点，喜欢收集奇怪的旧票据。', availableActions: ['chat','gift','trade','profile'], preferredGifts: ['berry-tart','copper-ingot'], birthday: { month: 9, day: 3 } },
  { id: 'yanque', name: '岩雀', role: '铁匠', locationId: 'smithy', description: '沉默而可靠，打造的工具会留下羽纹火花。', availableActions: ['chat','gift','trade','quest','profile'], preferredGifts: ['iron-ingot','fire-potion'], birthday: { month: 11, day: 8 } },
  { id: 'sera', name: '塞拉', role: '共生牧场店主', locationId: 'monster-market', description: '主张把魔物娘当作经营伙伴而非商品。', availableActions: ['chat','gift','trade','quest','profile'], preferredGifts: ['moonflower','slime-gel'], birthday: { month: 7, day: 22 } },
  { id: 'mira', name: '米菈', role: '育种师', locationId: 'monster-market', description: '能从脚印判断每一位伙伴今天的心情。', availableActions: ['chat','gift','trade','profile'], preferredGifts: ['milk','honey'], birthday: { month: 8, day: 9 } },
  { id: 'qiluo', name: '绮萝', role: '饲育员', locationId: 'monster-market', description: '会为不同种族调配带有星屑香味的饲料。', availableActions: ['chat','gift','trade','profile'], preferredGifts: ['amber-tea','thread-ball'], birthday: { month: 6, day: 2 } },
  { id: 'daifu', name: '黛芙', role: '五行魔女', locationId: 'witch-home', description: '住在林雾深处，出售药剂，也收藏失传法术。', availableActions: ['chat','gift','trade','quest','profile'], preferredGifts: ['moonflower','mana-potion'], birthday: { month: 10, day: 27 } },
  { id: 'rin', name: '凛', role: '猎人', locationId: 'hunter-camp', description: '负责标记魔物迁徙路线，训练从不拖泥带水。', availableActions: ['chat','gift','quest','profile'], preferredGifts: ['iron-ingot','silver-carp'], birthday: { month: 12, day: 5 } },
  { id: 'chaoyin', name: '潮音', role: '船主', locationId: 'fisher-home', description: '记得海湾里每一道潮汐的名字。', availableActions: ['chat','gift','trade','quest','profile'], preferredGifts: ['amber-tea','milk'], birthday: { month: 2, day: 19 } },
  { id: 'xiye', name: '汐野', role: '钓师', locationId: 'fisher-home', description: '相信最好的鱼竿应该听得见水下的歌。', availableActions: ['chat','gift','trade','profile'], preferredGifts: ['silver-carp','honey'], birthday: { month: 6, day: 24 } },
  { id: 'weina', name: '维娜', role: '医师', locationId: 'hospital', description: '诊断精准，但更在意病人有没有按时吃饭。', availableActions: ['chat','gift','trade','quest','profile'], preferredGifts: ['milk','sun-wheat'], birthday: { month: 1, day: 30 } },
  { id: 'sujin', name: '苏槿', role: '护理师', locationId: 'hospital', description: '准备的热敷草包能驱走矿洞最深处的寒气。', availableActions: ['chat','gift','profile'], preferredGifts: ['moonflower','berry-tart'], birthday: { month: 3, day: 29 } },
]

...
export const npcs: Npc[] = [
  ...
  { id: 'taomi', name: '桃弥', role: '账房', locationId: 'general-store', description: '算盘快得像雨点，喜欢收集奇怪的旧票据。', availableActions: ['chat','gift','trade','profile'], preferredGifts: ['moss-trout','copper-ingot'], birthday: { month: 9, day: 3 } },
  ...
  { id: 'sera', name: '塞拉', role: '共生牧场店主', locationId: 'monster-market', description: '主张把魔物娘当作经营伙伴而非商品。', availableActions: ['chat','gift','trade','quest','profile'], preferredGifts: ['tide-bass','slime-gel'], birthday: { month: 7, day: 22 } },
  ...
  { id: 'daifu', name: '黛芙', role: '五行魔女', locationId: 'witch-home', description: '住在林雾深处，出售药剂，也收藏失传法术。', availableActions: ['chat','gift','trade','quest','profile'], preferredGifts: ['moon-tail','mana-potion'], birthday: { month: 10, day: 27 } },
  { id: 'rin', name: '凛', role: '猎人', locationId: 'hunter-camp', description: '负责标记魔物迁徙路线，训练从不拖泥带水。', availableActions: ['chat','gift','quest','profile'], preferredGifts: ['iron-ingot','mist-catfish'], birthday: { month: 12, day: 5 } },
  ...
  { id: 'sujin', name: '苏槿', role: '护理师', locationId: 'hospital', description: '准备的热敷草包能驱走矿洞最深处的寒气。', availableActions: ['chat','gift','profile'], preferredGifts: ['moss-trout','mist-catfish'], birthday: { month: 3, day: 29 } },
]
